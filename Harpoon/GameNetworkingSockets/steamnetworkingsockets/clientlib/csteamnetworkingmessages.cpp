...
#include "../../public/minbase/minbase_macros.h"
#include "../../public/minbase/minbase_endian.h"
//#include "../../public/minbase/minbase_warnings.h"


#define Assert(VAR) ;
#define AssertMsg(VAR) ;
#define AssertMsg1(VAR) ;
#define AssertMsg2(VAR) ;
#define SpewVerbose(VAR) ;
#define SpewVerbose2(VAR) ;
#define SpewMsg(VAR) ;
