...
inline uint32 LoadLittleDWord(unsigned long* base, unsigned int dwordIndex)
{
	return LittleDWord(base[dwordIndex]);
}
...
inline void StoreLittleDWord(unsigned long* base, unsigned int dwordIndex, uint32 dword)
{
	base[dwordIndex] = LittleDWord(dword);
}
