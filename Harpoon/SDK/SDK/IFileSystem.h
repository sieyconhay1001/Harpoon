...
class MD5Value_t;
typedef unsigned long FileHandle_t;
typedef unsigned long FileFindHandle_t;
typedef unsigned long FileNameHandle_t;
typedef unsigned long FileAsyncRequest_t;
typedef unsigned long FSAsyncControl_t;
typedef unsigned long FSAsyncFile_t;
typedef unsigned long WaitForResourcesHandle_t;
