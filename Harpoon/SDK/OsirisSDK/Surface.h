...
public:
    ...
    VIRTUAL_METHOD(void, setTextPosition, 26, (T x, T y), (this, static_cast<int>(x), static_cast<int>(y)))
        ...
        VIRTUAL_METHOD(int, CreateNewTextureID, 43, (bool procedural = false), (this, procedural))
        VIRTUAL_METHOD(void, getScreenSize, 44, (int& w, int& h), (this, std::ref(w), std::ref(h)))
        //38
        VIRTUAL_METHOD(void, DrawSetTextureRGBA, 37, (int id, const unsigned char* rgba, int wide, int tall), (this, id, rgba, wide, tall))
        VIRTUAL_METHOD(void, DrawSetTexture, 38, (int id), (this, id))
        VIRTUAL_METHOD(void, DrawTexturedRect, 41, (int __x, int __y, int __x1, int __y1), (this, __x, __y, __x1, __y1))
