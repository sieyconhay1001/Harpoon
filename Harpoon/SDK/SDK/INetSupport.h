...
public:
	...
	virtual void ReserveServer(
		...
		void *pCallback, void**ppAsyncOperation ) = 0;
	...
	virtual void ProcessSocket( int sock, void* pHandler ) = 0;

	// Send a network packet
	virtual int SendPacket (
		NetworkChannel *chan, int sock,  const netadr_t &to,
