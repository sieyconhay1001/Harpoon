...
#pragma once
#include "../OsirisSDK/NetworkChannel.h"
...
class CNetMessagePB : public NetworkMessage,  public PB_OBJECT_TYPE
{
public:
	...
	virtual NetworkMessage* Clone() const
	{
...
public:
	...
	template< class _N >
	void Bind(NetworkChannel* pNetChannel, CUtlDelegate< bool(const typename _N::PBType_t& obj) > handler)
	{
		delete m_pBind;
...
private:
	...
	{
		BindParams(NetworkChannel* pNetChannel, CUtlDelegate< bool(const typename _N::PBType_t& obj) > handler)
		...
		virtual void SetNetChannel(NetworkChannel* netchan)
		{
		...
		virtual NetworkMessage* CreateFromBuffer(bf_read& buffer)
		{
			NetworkMessage* pMsg = new typename _N::MyType_t;
		...
		virtual bool Process(const NetworkMessage& src)
		{
